...
stage4/use: consolekit policykit networkmanager vim-syntax pch nsplugin webkit lzma automount gnutls samba xattr bash-completion gphoto2 ffmpeg zeroconf apm ssh faac network threads pulseaudio directfb xcb cleartype glitz dga sse mmx autoipd gnome-keyring avahi mmap applet exif pango nautilus laptop sse2 sse3 caps swat aspell
stage4/packages: 
